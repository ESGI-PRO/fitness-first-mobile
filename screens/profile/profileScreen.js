...
const ProfileScreen = ({ navigation }) => {
  ...
  function trainingRestDialog() {
    return (
      <Dialog.Container
        ...
        headerStyle={{ margin: 0.0 }}
        onRequestClose={() => {
          updateState({ showTrainingRestDialog: false });
        }}
      >
        <View style={{ backgroundColor: Colors.whiteColor }}>
            ...
            <MaterialIcons
              ...
              onPress={() => {
                currentTrainingRest > 5
                  ? updateState({
                      currentTrainingRest: currentTrainingRest - 5,
                    })
                  : null;
              }}
            />
          ...
          >
            <Text
              onPress={() =>
                updateState({
                  currentTrainingRest: dummyTrainingRest,
                  showTrainingRestDialog: false,
                })
              }
            ...
            <Text
              ...
              onPress={() =>
                updateState({
                  dummyTrainingRest: currentTrainingRest,
                  showTrainingRestDialog: false,
                })
              }
            >
  ...
  function workoutOptions() {
    return (
      <View>
        <Text
          style={{ margin: Sizes.fixPadding * 2.0, ...Fonts.grayColor13Bold }}
        >
          Workout
        </Text>
  ...
  function optionsShort({ option, navigateTo }) {
    return (
      <TouchableOpacity
        ...
        style={styles.optionsShortWrapStyle}
      >
        <Text style={{ flex: 1, ...Fonts.blackColor16Medium }}>{option}</Text>
        <MaterialIcons
          name="arrow-forward-ios"
          color={Colors.blackColor}
          size={18}
      ...
      <View style={styles.profileInfoWrapStyle}>
        ...
        <View style={{ flex: 1, flexDirection: "row", alignItems: "center" }}>
          ...
          <View style={{ flex: 1, marginLeft: Sizes.fixPadding }}>
            <Text style={{ ...Fonts.blackColor18SemiBold }}>{user.data?.userName}</Text>
